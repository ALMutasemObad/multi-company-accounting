...
test("generated OpenAPI guards are committed and current", () => {
  assert.equal(guardedOperationIds.length, 125);
  assert.equal(responseOperationIds.length, 241);
...
test("guard generation covers request transforms and response schemas", () => {
  ...
  assert.match(generated, /openApiContractCoverage = \{ operations: 241, requestBodies: 125, responseBodies: 1590 \}/u);

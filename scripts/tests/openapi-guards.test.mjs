...
test("generated OpenAPI guards are committed and current", () => {
  assert.equal(guardedOperationIds.length, 126);
  assert.equal(responseOperationIds.length, 244);
...
test("guard generation covers request transforms and response schemas", () => {
  ...
  assert.match(generated, /openApiContractCoverage = \{ operations: 244, requestBodies: 126, responseBodies: 1606 \}/u);

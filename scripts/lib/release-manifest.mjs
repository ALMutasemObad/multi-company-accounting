...
export const DEFAULT_RELEASE_FILES = [
  ...
  "scripts/lib/backup-artifact-verifier.mjs",
  "scripts/lib/backup-format.mjs",
  "scripts/lib/database-identities.mjs",
  "scripts/lib/mysql-tools.mjs",

...
if (pageHeaders !== 21) failures.push(`Expected 21 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 50) failures.push(`Expected 50 accessible table regions; found ${tableRegions}`);

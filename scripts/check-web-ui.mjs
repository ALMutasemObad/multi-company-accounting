...
if (pageHeaders !== 30) failures.push(`Expected 30 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 71) failures.push(`Expected 71 accessible table regions; found ${tableRegions}`);

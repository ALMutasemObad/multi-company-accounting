...
if (pageHeaders !== 19) failures.push(`Expected 19 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 47) failures.push(`Expected 47 accessible table regions; found ${tableRegions}`);

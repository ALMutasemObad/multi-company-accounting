...
if (pageHeaders !== 22) failures.push(`Expected 22 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 58) failures.push(`Expected 58 accessible table regions; found ${tableRegions}`);

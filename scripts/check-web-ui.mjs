...
if (pageHeaders !== 20) failures.push(`Expected 20 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 48) failures.push(`Expected 48 accessible table regions; found ${tableRegions}`);

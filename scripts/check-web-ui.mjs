...
if (pageHeaders !== 17) failures.push(`Expected 17 shared PageHeader usages; found ${pageHeaders}`);
if (tableRegions !== 33) failures.push(`Expected 33 accessible table regions; found ${tableRegions}`);

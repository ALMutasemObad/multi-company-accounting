export const arPosRecovery = {
  ...
  rejected: "أكد الخادم رفض المحاولة دون إنشاء أثر مالي. لن يعاد إرسال البيع تلقائيًا.", review: "مراجعة السلة وتعديلها", reviewHelp: "راجع البيانات قبل تأكيد بيع جديد. تبقى السلة الحالية كما هي؛ لا تستعاد البنود بعد إعادة تحميل الصفحة.",
...
export const enPosRecovery: PosRecoveryDictionary = {
  ...
  rejected: "The server confirmed this attempt was rejected without creating a financial effect. The sale will not be sent again automatically.", review: "Review and edit cart", reviewHelp: "Review the details before confirming a new sale. Your current cart is kept; items are not restored after a page reload.",
...
export const hiPosRecovery: PosRecoveryDictionary = {
  ...
  rejected: "सर्वर ने पुष्टि की कि प्रयास बिना वित्तीय प्रभाव के अस्वीकार हुआ। बिक्री अपने आप दोबारा नहीं भेजी जाएगी।", review: "कार्ट की समीक्षा और बदलाव करें", reviewHelp: "नई बिक्री की पुष्टि से पहले विवरण जाँचें। मौजूदा कार्ट रहेगा; पेज दोबारा लोड करने पर आइटम वापस नहीं आते।",
...
export const urPosRecovery: PosRecoveryDictionary = {
  ...
  rejected: "سرور نے تصدیق کی کہ کوشش کسی مالی اثر کے بغیر مسترد ہوئی۔ فروخت خود بخود دوبارہ نہیں بھیجی جائے گی۔", review: "ٹوکری کا جائزہ لیں اور ترمیم کریں", reviewHelp: "نئی فروخت کی تصدیق سے پہلے تفصیل دیکھیں۔ موجودہ ٹوکری برقرار ہے؛ صفحہ دوبارہ لوڈ کرنے کے بعد اشیا بحال نہیں ہوتیں۔",

...
type References = { customers: Customer[]; accounts: Account[]; accountTypes: AccountType[]; periods: FiscalPeriod[]; costCenters: CostCenter[]; currencies: Currency[]; taxRates: TaxRate[]; sourceInvoices: SalesInvoice[]; warehouses: Warehouse[]; inventoryItems: InventoryItem[] };
const emptyReferences: References = { customers: [], accounts: [], accountTypes: [], periods: [], costCenters: [], currencies: [], taxRates: [], sourceInvoices: [], warehouses: [], inventoryItems: [] };
...
type DraftLine = { inventoryItemId: string; inventoryItemLabel: string; description: string; quantity: string; unitPrice: string; discountAmount: string; revenueAccountId: string; costCenterId: string; taxRateId: string };
const blankLine = (): DraftLine => ({ inventoryItemId: "", inventoryItemLabel: "", description: "", quantity: "1", unitPrice: "", discountAmount: "0.0000", revenueAccountId: "", costCenterId: "", taxRateId: "" });

...
export const cashierScope: CashierContextScope = { userId: "7", companyId: "11", authorizationRevision: "1", permissions: ["pos.view", "pos.checkout", "warehouses.view", "cash_bank_accounts.view", "currencies.view"], modules: ["POS", "INVENTORY", "TREASURY"] };

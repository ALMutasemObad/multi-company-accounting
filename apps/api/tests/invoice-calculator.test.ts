...
describe("sales invoice calculator", () => {
  it("calculates quantities, discounts, VAT and base totals with four-decimal rounding", () => {
    const result = calculateTaxDocument([
      { description: "خدمات استشارية", quantity: "2.0000", unitPrice: "1000.0000", discountAmount: "100.0000", accountId: 1n, taxRateId: 2n, taxRate: "15.0000" },
      { description: "خدمة معفاة", quantity: "1.0000", unitPrice: "500.0000", discountAmount: "0.0000", accountId: 1n, taxRate: "0.0000" },
    ], "1.00000000");

...
- حدث OpenAPI والحارس المولد وواجهة Accounts. عند 409 لا تعيد الواجهة الأمر، بل
  تغلق snapshot التحرير القديم وتعيد تحميل البيانات. يشمل ذلك تطبيق القالب: يبقى
  CAS خادميًا بلا `expectedVersion` من العميل، ويعيد التعارض تحميل الحسابات وحالة
  القالب من دون replay.

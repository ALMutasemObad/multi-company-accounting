...
status: "approved sequencing; A through E1, B1, and F1 complete locally; CRM-1 gated by foundation and barcode E2E; F2 gated"
version: "1.7"
date: "2026-08-29"
related:
...
يرتب التنفيذ حسب أقصر دورة أعمال مكتملة وأقل مخاطرة محاسبية، لا حسب عدد الشاشات. بعد إغلاق العمل المهني والوقت وHR والموافقات والفوترة والتخطيط والجدار الأخلاقي، يصبح CRM مرشح دورة الأعمال التالية فقط بعد بوابة الأداء/الأمان/المحركين ومسار باركود E2E المحددة في ADR-014. يلي CRM فحص تعارض المصالح قبل أي تحويل من فرصة إلى قضية قانونية. تؤجل الرواتب وأموال العملاء حتى تتضح السياسة النظامية.
...
| CRM-1 | تطوير الأعمال | Lead → Opportunity → Customer عبر Sales Port وأنشطة Pipeline | أساس الأداء/الأمان + Barcode E2E + Sales + HR/Identity + Tenant | مخططة؛ تبدأ بعد بوابة ADR-014 |
...
ولا يبدأ تنفيذها قبل بوابة الدخول في ADR-014؛ تطبيقات المتجر الكاملة ليست شرط بدء،
لكن تصميم الواجهة المتجاوب وعدم إنشاء Backend هاتف موازٍ شرطان من أول شريحة.

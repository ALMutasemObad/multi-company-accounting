...
في 2026-08-27 اكتمل Backend المرحلة 2 محليًا وفق [عقد Backend المطابقة البنكية](BANK_RECONCILIATION_BACKEND_AR.md). بقي قرار الـSpike مقيدًا كما هو: المكتبتان داخل Adapters فقط، والـParser والـMatcher لا يكتبان Ledger. لم تبدأ واجهة المرحلة 3 ولم يحدث نشر.
